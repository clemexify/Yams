...
## Version courte (première connexion)

> Utilisée dans la modale d'accueil avec un bouton "Ne plus afficher".

### Comment jouer au Yams 5 colonnes

Lance 5 dés, relance ceux que tu veux, forme les meilleures combinaisons en 3 lancers max par tour. L'objectif est d'obtenir le meilleur score possible. Simple en apparence, redoutable en pratique.

**Ce qui rend ce Yams différent : 5 colonnes**

- **N — Normale** : libre, dans n'importe quel ordre
- **↓ — Descendante** : de haut en bas obligatoirement
- **↑ — Montante** : de bas en haut obligatoirement
- **S — Sèche** : tous les dés lancés en même temps, sans en avoir gardé aucun
- **A — Annoncée** : tu annonces ta cible après le 1er lancer, et tu assumes

**Le conseil de départ :** pense toujours à la Descendante et la Montante en premier. Et prévois un plan B si tu rates ta figure.

---

## Version longue (page dédiée accessible depuis l'accueil)
...
|--------|-----------|-------|
| Full | Un brelan + une paire | Somme des dés + 20 |
| Suite | 5 valeurs consécutives | Somme des dés + 30 |
| Carré | 4 dés identiques | 4× la valeur + 40 |
| Yams | 5 dés identiques | Somme des dés + 50 |
...
#### A — Annoncée
Après ton premier lancer, tu peux annoncer la case que tu vises. Tu t'engages publiquement — et tu ne peux plus changer d'avis. Si tu réussis, tu marques normalement. Si tu rates, tu inscris 0. L'annonce est un pari sur ta propre capacité à obtenir ce que tu vises.
...
**3. Le bonus chiffres, c'est 30 points**
3 fois chaque chiffre (en excluant les 1) suffit : 3×2=6, 3×3=9, 3×4=12, 3×5=15, 3×6=18, total = 60 points exactement. Si tu as de l'avance sur un chiffre, tu peux te permettre d'être moins précis sur un autre. Pense toujours à ta projection vers ce bonus — il change l'issue d'une partie.
